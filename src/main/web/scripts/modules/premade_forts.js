 ...
 * premade_forts.js
 * 
 * This module contains premade forts that the player can choose when starting the game. Just add
 * one to the list if you want to add another fort.
 * 
 */

$(function() {
    m3.premade_forts = function() {
        return [
            {
                id:   "Original",
                fort: {
