...
$(function() {
    m3.types.Projectile = function() {
        ...
        var ammunition = {
            rock: {
                small: { s: assets.rock, h: 38, w: 38, radius: 19,
        	             density: 2.0, restitution: 0.1, friction: 2.5, torque: 10,
        	             spawn: function(x, y) {
            ...
            banana: {
                ...
                triple: { s: assets.banana_green, h: 25, w: 25, icon: assets.banana_bunch,
            	          ...
            	          spawn: function(x, y, angle) {
          	                  return m3.world.createPoly(x / scale, y / scale, m3.util.pixelsToMeters(this.vertices), 0, false, this.density, this.restitution, this.friction);
                          }
                }
            },
            watermelon: {
                whole: 	{ s: assets.watermelon_explode, h: 30, w: 42, icon: assets.watermelon,
   	             		  density: 2.5, restitution: 0.1, friction: 1.25, torque: 10,
            ...
            monkey: { 
                medium: { s: assets.monkey_helmet, h: 51, w: 41, icon: assets.proj_monkey,
            	          density: 1.0, restitution: 0.5, friction: 1.0, torque: 10,
            	          spawn: function(x, y, angle) {
            	    	      return m3.world.createBox(x / scale, y / scale, this.w / scale, this.h / scale, 0, false, this.density, this.restitution, this.friction);
            	          }
                }
            }
        };
        ...
        // Constructor.
        Projectile.create = function(x, y, impulse, ammo, type) {
