    ...
    m3.types.Level = function() {
        return {
            ...
            create: function() {
                ...
                level.fortresses[0].addLauncher("cannon", "grey", 175, 360, 0, m3.types.Vector.create(22, 40));
                level.fortresses[1].addLauncher("cannon", "grey", -120, 360, 0, m3.types.Vector.create(71, 40));
